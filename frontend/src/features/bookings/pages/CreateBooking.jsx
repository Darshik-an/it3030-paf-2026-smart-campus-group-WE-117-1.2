...
const CreateBooking = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-y-auto overflow-x-hidden bg-[radial-gradient(circle_at_top_left,_#dbeafe_0%,_#eef2ff_45%,_#f8fafc_100%)] py-6 md:py-10">
      <div className="absolute -top-20 -right-16 h-64 w-64 rounded-full bg-blue-200/40 blur-3xl" aria-hidden="true"></div>
      <div className="absolute top-1/3 -left-20 h-72 w-72 rounded-full bg-indigo-200/30 blur-3xl" aria-hidden="true"></div>

      <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-8 pb-14">
        <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-r from-[#003049] via-[#0e4f75] to-[#247bb8] p-6 md:p-8 text-white shadow-xl shadow-slate-300/40 mb-6">
        ...
        <div className="mt-8 bg-white/95 border border-blue-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
